...
import { removeArticle } from '../store/slices/articles-slice';

export const RemoveButton = ({ arrticleId }: { arrticleId: number }) => {
    const dispatch = useAppDispatch();
    const removeArticleHandler = (event: React.MouseEvent) => {
        event.preventDefault();
        dispatch(removeArticle(arrticleId));
    };

    return (
        <button
            onClick={e => removeArticleHandler(e)}
